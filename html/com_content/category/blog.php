					...
					<?php if ($counter == 0) { ?>
						<div itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting"  >
							<?php if (!empty($images->image_intro)) { ?>
								<img src="<?php echo $images->image_intro; //вступительное изображение материала ?>" alt="<?php echo $item->title; ?>" style = "padding-right:15px; padding-left:15px;"/>
							<?php } ?>	
							<div class = "inline-block">
								<h1><a href="<?php echo $link; ?>"><?php echo $item->title; // название материала ?></a></h1>
